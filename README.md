...
The default promotion path uses refined chart words; Poincare-section words and section sweeps are available as stricter diagnostics when a scenario has enough crossings.
