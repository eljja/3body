...
- A fixed left navigation rail swaps the right-side research content workspace in place, including ThreeBody, the closed-form route, and the methodologically related Collatz panel, plus a direct GitHub repository shortcut. Riemann, Goldbach, and twin-prime panels are intentionally not shown on the ThreeBody public page because they are not part of the current three-body evidence bundle.
