...
4. Embed the resulting Plotly figures, certificate bars, promotion gates, progress-map timeline, evidence publication pipeline, and metrics into `site/index.html`.
