...
- `python -m threebody.cli verify-static-artifacts --base-url https://eljja.github.io/3body/ --require-commit <sha-or-prefix> --output .runtime/research_runs/pages-verification-receipt.json`
