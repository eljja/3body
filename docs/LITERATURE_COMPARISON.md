...
The newest re-entry target treats high-crossing and hysteresis as branch classification over this grammar, explicitly separating branch prediction from failed scalar boundary collapse.
