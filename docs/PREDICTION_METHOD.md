...
- `target_positions`, `target_position_distribution`, `target_position_table`, `target_pair_geometry`, and `target_distribution_quality` in the compact `solve_three_body_target_positions(...)` answer.
