...
def test_theorem_suite_reports_candidates_and_benchmarks() -> None:
    ...
    assert any(benchmark["name"] == "jacobi_interval_tail_escape_margin" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_interval_flow_tube" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_interval_picard_flow" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_picard_interval_jacobian_contraction" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_picard_resolution_crosscheck" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_picard_resolution_margin_spread" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_quadrupole_acceleration_envelope" for benchmark in summary["benchmarks"])
    ...
    assert any(benchmark["name"] == "jacobi_parameter_interval_tail_margin" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_parameter_flow_tube_margin" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_parameter_picard_flow_margin" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_parameter_picard_interval_box_margin" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_parameter_picard_cell_centers" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "jacobi_parameter_picard_face_centers" for benchmark in summary["benchmarks"])
    ...
    assert any(benchmark["name"] == "figure_eight_noether_invariants" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "figure_eight_center_of_mass_reduction" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "figure_eight_lagrange_jacobi_identity" for benchmark in summary["benchmarks"])
    assert any(benchmark["name"] == "figure_eight_sundman_inequality" for benchmark in summary["benchmarks"])
